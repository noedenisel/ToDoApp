...
function buildToDo(ToDo, index) {
 ...
 const toDoShell = document.createElement('div')  //Crear un elemento 'div' y asignárselo a una variable denominada 'toDoShell'
...
const checkbox = document.createElement('input') //checkbox no existe
...
toDoShell.appendChild(checkbox)
 ...
 return toDoShell //Agregar 'toDoText' como hijo de 'toDoShell'
...
function displayToDos() {
  ...
  let toDoContainer = document.querySelector('#toDoContainer') //Seleccionr el elemento cuyo id es 'toDoContainer' y almacenarlo en una variable denominada 'toDoContainer'
